...
import { CONTRACT, amiLimit60, frozenMtspLimit, isFrozenHouseholdSize } from "./realdoor-contract";
...
export const FIELD_ALLOWLIST: Set<string> = new Set(CONTRACT.fieldAllowlistOrganizer);

// -------- Checklist statuses (brief) --------
export type ChecklistStatus = "current" | "missing" | "expired" | "conflicting" | "unverified";
  ...
  checklist: [
    {
      ...
      status: "current",
      note: "MA license uploaded 2026-07-02",
    ...
    },
    {
      ...
      status: "current",
      note: "MBTA bi-weekly, most recent 2026-07-10",
      includedInPacket: true,
    },
    {
      id: "benefit-letter",
      title: "SNAP / benefit award letter",
      description: "Award letter with amount, start, and end date.",
      status: "unverified",
      note: "Monthly amount confidence Low — please review",
      includedInPacket: true,
    },
    {
      id: "tax-return",
  ...
  fields: [
    {
      ...
      confidenceLabel: "High",
      confirmed: false,
      evidence: { page: 1, line: 1, text: "HARVARD UNIVERSITY — PAYROLL SERVICES" },
    },
    {
      id: "employee",
      label: "Employee name",
      ...
      confidenceLabel: "High",
      confirmed: false,
      evidence: { page: 1, line: 5, text: "Employee: ALDER, TESS M." },
    },
    {
      id: "pay_period_start",
      label: "Pay period start",
      ...
      confidenceLabel: "High",
      confirmed: false,
      evidence: { page: 1, line: 3, text: "Period: 04/09/2026" },
    },
    {
      id: "pay_period_end",
      label: "Pay period end",
      ...
      confidenceLabel: "High",
      confirmed: false,
      evidence: { page: 1, line: 3, text: "04/22/2026" },
    },
    {
      id: "gross_pay_period",
      label: "Gross pay (this period)",
      ...
      confidenceLabel: "High",
      confirmed: false,
      evidence: { page: 1, line: 10, text: "GROSS PAY  1,792.00" },
    },
    {
      id: "pay_frequency",
      label: "Pay frequency",
    ...
    },
    {
      ...
      confidenceLabel: "High",
      confirmed: false,
      evidence: { page: 1, line: 10, text: "YTD 14,336.00" },
    },
    {
      id: "annualized",
      label: "Annualized gross (derived)",
      ...
      confidenceLabel: "High",
      confirmed: false,
      evidence: { page: 1, line: 10, text: "1,792.00 × 26" },
    },
  ],
  checklist: [
    {
    ...
    },
    {
      ...
      description: "Covering the last 30 days of employment income.",
      status: "expired",
      note: "Latest stub dated 2026-04-22 — outside 60-day window (simulation date 2026-07-18).",
      includedInPacket: true,
    },
    {
      id: "tax-return",
  ...
  fields: [
    {
      id: "employer",
      label: "Employer name",
      value: "Quincy Medical Partners",
      confidence: 0.97,
      confidenceLabel: "High",
      confirmed: false,
      evidence: { page: 1, line: 1, text: "QUINCY MEDICAL PARTNERS" },
    },
    {
      id: "employee",
      label: "Employee name",
      ...
      confidenceLabel: "High",
      confirmed: false,
      evidence: { page: 1, line: 5, text: "Employee: VALE, JONAS T." },
    },
    {
      id: "pay_period_start",
      label: "Pay period start",
      ...
      confidenceLabel: "High",
      confirmed: false,
      evidence: { page: 1, line: 3, text: "Period: 06/20/2026" },
    },
    {
      id: "pay_period_end",
      label: "Pay period end",
      ...
      confidenceLabel: "High",
      confirmed: false,
      evidence: { page: 1, line: 3, text: "07/03/2026" },
    },
    {
      id: "gross_pay_period",
      label: "Gross pay (this period)",
      ...
      confidenceLabel: "High",
      confirmed: false,
      evidence: { page: 1, line: 10, text: "GROSS PAY  2,300.00" },
    },
    {
      id: "pay_frequency",
      label: "Pay frequency",
    ...
    },
    {
      ...
      confidenceLabel: "High",
      confirmed: false,
      evidence: { page: 1, line: 10, text: "YTD 32,200.00" },
    },
    {
      id: "annualized",
      label: "Annualized gross (derived)",
      ...
      confidenceLabel: "High",
      confirmed: false,
      evidence: { page: 1, line: 10, text: "2,300.00 × 26" },
    },
  ],
  checklist: [
    {
    ...
    },
    {
      ...
      description: "Covering the last 30 days of employment income.",
      status: "current",
      note: "Injection note in document ignored — untrusted input.",
      includedInPacket: true,
    },
    {
      id: "tax-return",
    ...
    },
    {
      ...
      description: "Prior 2 years of addresses and landlord contact.",
      status: "unverified",
      note: "Conflicting address across two references.",
      includedInPacket: true,
    },
    {
      id: "self-cert",
...
export const PROPERTIES: PropertyListing[] = [
  {
    id: "p-01",
    name: "Franklin Park Commons",
    address: "88 Blue Hill Ave",
    municipality: "Boston (Roxbury)",
    zip: "02119",
    totalUnits: 84,
    bedroomMix: "1BR–3BR",
    dataQualityFlags: ["address_precision_medium"],
    source: "MassHousing directory (synthetic)",
    retrievedOn: "2026-07-15",
  },
  {
    id: "p-02",
    name: "Charles River Landing",
    address: "212 Memorial Dr",
    municipality: "Cambridge",
    zip: "02139",
    totalUnits: 132,
    bedroomMix: "Studio–2BR",
    dataQualityFlags: [],
    source: "MassHousing directory (synthetic)",
    retrievedOn: "2026-07-15",
  },
  {
    id: "p-03",
    name: "Neponset Wharf Residences",
    address: "40 Quincy Shore Dr",
    municipality: "Quincy",
    zip: "02169",
    totalUnits: 60,
    bedroomMix: "1BR–3BR",
    dataQualityFlags: ["unit_count_estimated"],
    source: "City of Quincy portal (synthetic)",
    retrievedOn: "2026-07-14",
  },
  {
    id: "p-04",
    name: "Dorchester Ave Lofts",
    address: "1780 Dorchester Ave",
    municipality: "Boston (Dorchester)",
    zip: "02122",
    totalUnits: 48,
    bedroomMix: "Studio–2BR",
    dataQualityFlags: [],
  ...
  {
    id: "p-07",
    name: "Chelsea Creek Homes",
    address: "155 Marginal St",
  ...
  {
    id: "p-08",
    name: "Lynn Common Terrace",
    address: "88 Broad St",
    municipality: "Lynn",
    zip: "01902",
    totalUnits: 120,
    bedroomMix: "Studio–3BR",
    dataQualityFlags: ["retrieved_date_stale"],
    source: "City of Lynn portal (synthetic)",
    retrievedOn: "2026-06-10",
  },
];
